...
import com.appkero.backend_kero.repositories.PasswordResetTokenRepository;
...
public class JwtTokenService {
    ...
    public String generatePasswordResetToken(Usuario user) {
        ...
        PasswordResetToken passwordResetToken = PasswordResetToken.builder().token(token).usuario(user).build();
        return token;
    }
